...
void MathSetupFunc(Picoc *picoc)
{
    VariableDefinePlatformVar(picoc, NULL, "M_E", &picoc->FPType,
        (AnyValue*)&M_EValue, false);
    VariableDefinePlatformVar(picoc, NULL, "M_LOG2E", &picoc->FPType,
        (AnyValue*)&M_LOG2EValue, false);
    VariableDefinePlatformVar(picoc, NULL, "M_LOG10E", &picoc->FPType,
        (AnyValue*)&M_LOG10EValue, false);
    VariableDefinePlatformVar(picoc, NULL, "M_LN2", &picoc->FPType,
        (AnyValue*)&M_LN2Value, false);
    VariableDefinePlatformVar(picoc, NULL, "M_LN10", &picoc->FPType,
        (AnyValue*)&M_LN10Value, false);
    VariableDefinePlatformVar(picoc, NULL, "M_PI", &picoc->FPType,
        (AnyValue*)&M_PIValue, false);
    VariableDefinePlatformVar(picoc, NULL, "M_PI_2", &picoc->FPType,
        (AnyValue*)&M_PI_2Value, false);
    VariableDefinePlatformVar(picoc, NULL, "M_PI_4", &picoc->FPType,
        (AnyValue*)&M_PI_4Value, false);
    VariableDefinePlatformVar(picoc, NULL, "M_1_PI", &picoc->FPType,
        (AnyValue*)&M_1_PIValue, false);
    VariableDefinePlatformVar(picoc, NULL, "M_2_PI", &picoc->FPType,
        (AnyValue*)&M_2_PIValue, false);
    VariableDefinePlatformVar(picoc, NULL, "M_2_SQRTPI", &picoc->FPType,
        (AnyValue*)&M_2_SQRTPIValue, false);
    VariableDefinePlatformVar(picoc, NULL, "M_SQRT2", &picoc->FPType,
        (AnyValue*)&M_SQRT2Value, false);
    VariableDefinePlatformVar(picoc, NULL, "M_SQRT1_2", &picoc->FPType,
