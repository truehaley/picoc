...
#if 0
void StdlibBsearch(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
#if 0
void StdlibDiv(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
void StdlibLdiv(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
LibraryFunction StdlibFunctions[] =
{
