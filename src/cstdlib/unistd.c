...
void UnistdAccess(ParseState *Parser, Value *ReturnValue,
...
void UnistdAlarm(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
    ReturnValue->Val->Integer = alarm(Param[0]->Val->Integer);
}

void UnistdChdir(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
    ReturnValue->Val->Integer = chdir(Param[0]->Val->Pointer);
}

void UnistdChroot(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
    ReturnValue->Val->Integer = chroot(Param[0]->Val->Pointer);
}

void UnistdChown(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
void UnistdClose(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
    ReturnValue->Val->Integer = close(Param[0]->Val->Integer);
}

void UnistdConfstr(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
void UnistdCtermid(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
#if 0
void UnistdCuserid(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
void UnistdDup(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
    ReturnValue->Val->Integer = dup(Param[0]->Val->Integer);
}

void UnistdDup2(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
    ReturnValue->Val->Integer = dup2(Param[0]->Val->Integer, Param[1]->Val->Integer);
}

void Unistd_Exit(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
    _exit(Param[0]->Val->Integer);
}

void UnistdFchown(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
void UnistdFchdir(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
    ReturnValue->Val->Integer = fchdir(Param[0]->Val->Integer);
}

void UnistdFdatasync(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
#ifdef F_FULLSYNC
    /* Mac OS X equivalent */
...
void UnistdFork(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
    ReturnValue->Val->Integer = fork();
}

void UnistdFpathconf(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
void UnistdFsync(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
    ReturnValue->Val->Integer = fsync(Param[0]->Val->Integer);
}

void UnistdFtruncate(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
void UnistdGetcwd(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
void UnistdGetdtablesize(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
    ReturnValue->Val->Integer = getdtablesize();
}

void UnistdGetegid(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
    ReturnValue->Val->Integer = getegid();
}

void UnistdGeteuid(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
    ReturnValue->Val->Integer = geteuid();
}

void UnistdGetgid(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
    ReturnValue->Val->Integer = getgid();
}

void UnistdGethostid(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
    ReturnValue->Val->Integer = gethostid();
}

void UnistdGetlogin(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
    ReturnValue->Val->Pointer = getlogin();
}

void UnistdGetlogin_r(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
void UnistdGetpagesize(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
    ReturnValue->Val->Integer = getpagesize();
}

void UnistdGetpass(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
#if 0
void UnistdGetpgid(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
void UnistdGetpgrp(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
    ReturnValue->Val->Integer = getpgrp();
}

void UnistdGetpid(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
    ReturnValue->Val->Integer = getpid();
}

void UnistdGetppid(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
#if 0
void UnistdGetsid(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
void UnistdGetuid(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
    ReturnValue->Val->Integer = getuid();
}

void UnistdGetwd(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
    ReturnValue->Val->Pointer = getcwd(Param[0]->Val->Pointer, PATH_MAX);
}

void UnistdIsatty(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
    ReturnValue->Val->Integer = isatty(Param[0]->Val->Integer);
}

void UnistdLchown(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
void UnistdLink(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
void UnistdLockf(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
void UnistdLseek(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
void UnistdNice(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
    ReturnValue->Val->Integer = nice(Param[0]->Val->Integer);
}

void UnistdPathconf(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
void UnistdPause(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
#if 0
void UnistdPread(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
void UnistdPwrite(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
void UnistdRead(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
void UnistdReadlink(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
void UnistdRmdir(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
void UnistdSbrk(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
void UnistdSetgid(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
    ReturnValue->Val->Integer = setgid(Param[0]->Val->Integer);
}

void UnistdSetpgid(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
void UnistdSetpgrp(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
    ReturnValue->Val->Integer = setpgrp();
}

void UnistdSetregid(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
void UnistdSetreuid(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
void UnistdSetsid(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
    ReturnValue->Val->Integer = setsid();
}

void UnistdSetuid(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
    ReturnValue->Val->Integer = setuid(Param[0]->Val->Integer);
}

void UnistdSleep(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
#if 0
void UnistdSwab(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
void UnistdSymlink(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
void UnistdSync(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
    sync();
}

void UnistdSysconf(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
    ReturnValue->Val->Integer = sysconf(Param[0]->Val->Integer);
}

void UnistdTcgetpgrp(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
    ReturnValue->Val->Integer = tcgetpgrp(Param[0]->Val->Integer);
}

void UnistdTcsetpgrp(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
void UnistdTruncate(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
void UnistdTtyname(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
    ReturnValue->Val->Pointer = ttyname(Param[0]->Val->Integer);
}

void UnistdTtyname_r(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
void UnistdUalarm(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
void UnistdUnlink(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
    ReturnValue->Val->Integer = unlink(Param[0]->Val->Pointer);
}

void UnistdUsleep(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
void UnistdVfork(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
void UnistdWrite(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
