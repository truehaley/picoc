...
void StringStrlen(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
void StringStrxfrm(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
...
#ifndef WIN32
void StringStrdup(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
    ReturnValue->Val->Pointer = (void*)strdup(Param[0]->Val->Pointer);
}

void StringStrtok_r(ParseState *Parser, Value *ReturnValue,
    Value **Param, int NumArgs)
{
